...
const ENTRIES: { date: string; items: string[] }[] = [
  {
    ...
    items: [
      ...
      '旧市町村 名前クイズ: 正解発表マップに所属する現市町村の輪郭を黒でハイライト（政令市は市名回答なら全区をまとめて表示）',
      '旧市町村 名前クイズ: 正解発表マップを拡大し、地図上の常時ラベルを廃止（ホバーで表示）。誤答時に入力欄を自動クリア。1県のみの出題では都道府県ヒントの代わりにふりがなを ◯ のルビで表示（末尾の 市/町/村/区 の読みだけ開示: ○○し・○○○まち 等）',
    ],
  },
  {
    date: '2026-07-30',
